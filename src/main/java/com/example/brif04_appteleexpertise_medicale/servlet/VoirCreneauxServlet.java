...
@WebServlet("/generaliste/voirCreneaux")
public class VoirCreneauxServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Récupérer la consultation et le spécialiste
            ...
            // Récupérer les créneaux disponibles pour ce spécialiste à cette date
            List<String> creneauxDisponibles = demandeService.getCreneauxDisponibles(specialisteId, dateRendezVous);

            // Passer les données à la page
            request.setAttribute("consultation", consultation);
            request.setAttribute("specialiste", specialiste);
            request.setAttribute("dateRendezVous", dateRendezVous);
            request.setAttribute("creneauxDisponibles", creneauxDisponibles);

            request.getRequestDispatcher("/WEB-INF/views/generaliste/choisirCreneau.jsp").forward(request, response);
